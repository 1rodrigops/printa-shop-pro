...
import VendasDoDia from "@/components/vendas/VendasDoDia";
import HistoricoPedidos from "@/components/vendas/HistoricoPedidos";
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 pt-24 pb-8">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">Central operacional de pedidos e vendas</p>
        </div>
        ...
        <Tabs defaultValue="pedidos" className="space-y-4">
          <TabsList className="grid w-full grid-cols-3 lg:w-[600px]">
            ...
            <TabsTrigger value="diarias">📊 Vendas do Dia</TabsTrigger>
